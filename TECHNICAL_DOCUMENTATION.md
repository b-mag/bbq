...
## Appendix: How to Convert This to PDF

This document is Markdown. To produce a PDF:

```powershell
# Option 1: VS Code extension "Markdown PDF"
# Open this file → Ctrl+Shift+P → "Markdown PDF: Export (pdf)"

# Option 2: Pandoc (if installed)
pandoc TECHNICAL_DOCUMENTATION.md -o TECHNICAL_DOCUMENTATION.pdf

# Option 3: Use a web tool like https://markdowntopdf.com/
```

---

*Document generated August 2026. For the latest state of the codebase, always refer to the source files directly.*
